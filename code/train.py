...
def get_name(args):
    ...
    return f"{args.task}-adapt{int(args.adaptive)}-gamma{args.gamma}-lr{args.lr}-rho{args.rho}-{args.uid}{suffix}"
...
if __name__ == "__main__":
    ...
    P.add_argument("--opt", choices=["sgd", "sam", "msam"], required=True,
        help="optimizer")
    P.add_argument("--adaptive", default=True, type=bool,
    ...
    P.add_argument("--momentum", default=0.9, type=float,
        help="SGD Momentum.")
    P.add_argument("--threads", default=2, type=int,
    ...
    if args.opt == "sgd":
        ...
        optimizer = MSAM(model.parameters(), base_optimizer, gamma=args.gamma, rho=args.rho, adaptive=args.adaptive, lr=args.learning_rate, momentum=args.momentum, weight_decay=args.weight_decay)
